...
SCHEM_IMG_H    = 300   # actual schematic image height (increase/decrease as you like)
SCHEM_OFFSET_X = 120    # move schematic right (+) / left (-)
SCHEM_OFFSET_Y = 120    # move schematic down (+) / up (-)
