...
# ========================== FIT-TO-SCREEN (added) ==========================
# Scales the entire UI to the viewer's screen, so nobody needs to scroll.
# Does not change your colors/positions—just scales the finished frame.
st.markdown("""
<style>
:root{
  /* Pick a design frame large enough to include EVERYTHING in your layout.
     If something barely clips on your monitor, raise these a bit once. */
  --design-w: 2300;     /* try 2350–2400 if needed */
  --design-h: 1250;     /* try 1280–1300 if needed */
...
/* stop framework paddings from pushing UI off-screen */
[data-testid="stAppViewContainer"]{ padding-left:0 !important; padding-right:0 !important; }
/* keep header hidden (your code already styles its own header) */
header[data-testid="stHeader"]{ height:0 !important; padding:0 !important; background:transparent !important; }
header[data-testid="stHeader"] *{ display:none !important; }
/* guard against rogue overflow from widgets/charts */
section.main{ overflow:hidden !important; }
div[tabindex="0"][style*="overflow: auto"]{ overflow:hidden !important; }
</style>
<div id="fit-to-screen">
""", unsafe_allow_html=True)
# ======================== END FIT-TO-SCREEN (added) ========================

FS_TITLE   = 34   # slightly smaller so title fits in one line
FS_SECTION = 28
FS_LABEL   = 24
FS_UNITS   = 16
FS_INPUT   = 18
...
<style>
  ...
  /* Model select + buttons in one line */
  #action-row {{
    display:flex; flex-wrap:nowrap; align-items:center; gap:28px;
    margin-top: 6px;
  }}
  div[data-testid="stSelectbox"] > div > div {{
    height:50px !important; display:flex; align-items:center;
  }}
  div.stButton > button {{
