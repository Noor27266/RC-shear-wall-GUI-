...
with right:
    ...
    /* THIS LINE CONTROLS HOW HIGH THE DI–θ PLOT APPEARS */
    div.element-container:has(> iframe) {{
        position: relative !important;
        top: -150px !important;   /* <- make more negative to move plot UP */
    }}
    </style>
    """, unsafe_allow_html=True)
...
# aggressive chart-up CSS (kept to preserve final position)
css("""
<style>
div[data-testid="column"]:last-child {
    position: relative !important;
