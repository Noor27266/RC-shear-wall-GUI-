...
# (this is the ONLY header/layout block kept – the earlier duplicate was removed)
# =============================================================================
st.markdown("""
<style>
...
# (form-banner rule removed here to avoid duplication; final override kept at STEP 12)
# =============================================================================
css(f"""
<style>
...
# (SECOND results_df init was here; removed as duplicate)
...
# (this is the ONLY form-banner rule now)
# =============================================================================
st.markdown("""
<style>
.form-banner{
