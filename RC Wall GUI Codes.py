...
# Small right-column shift (KEEP) — removed iframe-specific rule that was pinning the chart
css("""
<style>
...
if (model_choice is None) or (model_choice not in model_registry):
    ...
    # =============================================================================
    # 📈 RENDER DI–θ PLOT (controls vertical spacing below logo/buttons)
    # =============================================================================
    with right:
        col1_c, col2_c, col3_c = st.columns([1, 8, 1])

        with col2_c:
            # small negative margin so DI–θ plot sits close to content above
            st.markdown(
