...
with left:
    ...
    st.markdown("<div class='form-banner' style='margin-top: -15px;'>Inputs Features</div>", unsafe_allow_html=True)
    st.markdown("<style>.section-header{margin:0.2rem 0 !important;}</style>", unsafe_allow_html=True)
    css("<div id='leftwrap'>")
